...
export declare const flash_expire_timeout_id_b: import("@ctx-core/object").Be<flash_expire_timeout_id_Ctx, "flash_expire_timeout_id", flash_expire_timeout_id_T>;
